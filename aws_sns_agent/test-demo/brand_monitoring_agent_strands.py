#!/usr/bin/env python3
"""
Brand Monitoring Agent using Strands framework (following lab1_py.py pattern)

This script defines a set of tools for brand monitoring using the same pattern as lab1_py.py,
but adapted for brand monitoring tasks instead of customer support.
"""
...
if __name__ == '__main__':
    ...
    # --- Step 3: Test the Brand Monitoring Agent ---
    print("\nNow testing the agent with sample queries...")

    print("\n--- Test 1: Brand Search ---")
    query1 = "Search for mentions of 'OpenAI' and analyze the sentiment"
    print(f"Query: {query1}")
    response1 = agent(query1)
    print(f"Response: {response1}")

    print("\n--- Test 2: Brand Report Generation ---")
    query2 = "Generate a comprehensive brand monitoring report for 'Hugging Face'"
    print(f"Query: {query2}")
    response2 = agent(query2)
    print(f"Response: {response2}")

    print("\n--- Test 3: Sentiment Analysis ---")
    query3 = "Analyze the current sentiment around 'Anthropic' brand mentions"
    print(f"Query: {query3}")
    response3 = agent(query3)
    print(f"Response: {response3}")

    print("\n--- Test 4: Multi-source Search ---")
    query4 = "Search for 'DeepSeek' mentions using both BrightData and DuckDuckGo"
